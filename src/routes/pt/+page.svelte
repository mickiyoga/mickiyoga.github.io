...
<template>
  <ContentPage title="Personal Training" divider="ocean">
    <p>Personal training is available, with a focus on fitness, posture and flexibility.</p>
    <p>
    ...
    <div class="box">
      <enhanced:img src="/src/lib/assets/multiscreen.jpg" />
    </div>
  </ContentPage>
</template>
